  ...
  return <>
    ...
    <div style={{ padding:24, maxWidth:1200, margin:'0 auto' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:16, marginBottom:24 }}>
        ...
        <StatCard icon="🎫" label="New" value={stats.new_jobs||0} sub="Belum ada PIC" color="#F59E0B" />
        <StatCard icon="🙋" label="Assigned" value={stats.assigned_jobs||0} sub="Dah diambil, belum start" color="#3A86FF" />
      ...
      <div style={{ display:'flex', gap:16, marginBottom:24, flexWrap:'wrap' }}>
        {[{l:'Pipeline Value',v:formatRM(stats.pipeline_value),s:'New + Assigned + Active',c:'#E91E63'},{l:'Potential Value',v:formatRM(stats.potential_value),s:'Belum confirm',c:'#6366F1'},{l:'Actual Revenue',v:formatRM(stats.actual_revenue),s:`${stats.completed_jobs||0} job selesai`,c:'#10B981'}].map((c,i)=>
