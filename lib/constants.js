...
export const DOC_TYPE_META = {
  quotation: { label: 'Sebut Harga', icon: '📄', color: '#6366F1' },
  proforma:  { label: 'Invois Proforma', icon: '📋', color: '#3A86FF' },
  invoice:   { label: 'Invois', icon: '📑', color: '#10B981' },
  receipt:   { label: 'Resit', icon: '🧾', color: '#E85D04' },
}
