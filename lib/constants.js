...
// One combined line per moment of the day — the greeting period (Morning/
// Afternoon/Evening/Night) and a light, human touch tied to Kretivco's
// actual office hours (8:30am-5:30pm), instead of two separate lines. No
// dashes in the wording — reads more like something a person would type.
const GREETING_WINDOWS = [
  { start: 1380, end: 1439, period: 'Good Night',     line: (n) => `Assalamualaikum & Good Night, ${n}. Lewat malam ni, take care tau.` },
  { start: 0,    end: 299,  period: 'Good Night',     line: (n) => `Assalamualaikum & Good Night, ${n}. Lewat malam ni, take care tau.` },
  { start: 300,  end: 479,  period: 'Good Morning',   line: (n) => `Assalamualaikum & Good Morning, ${n}. Awal lagi ni, jom mulakan hari dengan secawan kopi.` },
  { start: 480,  end: 509,  period: 'Good Morning',   line: (n) => `Assalamualaikum & Good Morning, ${n}. Kerja start pukul 8:30, dah bersedia?` },
  { start: 510,  end: 659,  period: 'Good Morning',   line: (n) => `Assalamualaikum & Good Morning, ${n}. Pagi bersemangat, apa job pertama hari ni?` },
  { start: 660,  end: 779,  period: 'Good Afternoon', line: (n) => `Assalamualaikum & Good Afternoon, ${n}. Nak lunch hour dah ni? Makan mana tu?` },
  { start: 780,  end: 959,  period: 'Good Afternoon', line: (n) => `Assalamualaikum & Good Afternoon, ${n}. Lepas makan jangan mengantuk, jom sambung kerja.` },
  { start: 960,  end: 1049, period: 'Good Afternoon', line: (n) => `Assalamualaikum & Good Afternoon, ${n}. Last lap untuk hari ni, sikit lagi sampai pukul 5:30.` },
  { start: 1050, end: 1139, period: 'Good Evening',   line: (n) => `Assalamualaikum & Good Evening, ${n}. Dah pukul 5:30, jom settle kerja last-last dan balik.` },
  { start: 1140, end: 1379, period: 'Good Evening',   line: (n) => `Assalamualaikum & Good Evening, ${n}. Kerja lagi lepas waktu pejabat ni, jangan lupa rehat.` },
]
