...
export const MOCK_USERS = [
  ...
  { id:'u4', name:'Amnan Syahmi', title:'CTO', email:'amnan@kretiv.co', role:'dept_head', department:'tech', visible_departments:['tech','work'], active:true, created_at:'2026-03-01' },
]
