...
export const MOCK_USERS = [
  { id:'u1', staff_id:'EMP-001', name:'Amirul Hafiz', title:'CEO', email:'amirul@kretiv.co', role:'bod', department:null, active:true, created_at:'2026-01-01' },
  { id:'u2', staff_id:'EMP-002', name:'Nurfadilah Rahmat', title:'CMO', email:'nurfadilah@kretiv.co', role:'bod', department:null, active:true, created_at:'2026-01-01' },
  { id:'u3', staff_id:'EMP-003', name:'Afiq Azlan', title:'COO', email:'afiq@kretiv.co', role:'bod', department:null, active:true, created_at:'2026-01-01' },
  { id:'u4', staff_id:'EMP-004', name:'Amnan Syahmi', title:'CTO', email:'amnan@kretiv.co', role:'dept_head', department:'tech', visible_departments:['tech'], active:true, created_at:'2026-03-01' },
  { id:'u5', staff_id:'EMP-005', name:'Syahren', title:null, email:'syahren@kretiv.co', role:'staff', department:'print', visible_departments:['print','work','tech','event','wisb'], active:true, created_at:'2026-03-01' },
]
