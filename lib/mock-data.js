...
export const MOCK_USERS = [
  ...
  { id:'u5', name:'Syahren', title:null, email:'syahren@kretiv.co', role:'staff', department:'print', visible_departments:['print','work','tech','event','wisb'], active:true, created_at:'2026-03-01' },
]
