...
export function DataProvider({ children }) {
  ...
  const fetchAll = useCallback(async () => {
    ...
    ;(aR.data || []).forEach(l => {
      ...
      logs[key].push({ action: l.action, user: l.user_name || 'System', detail: l.detail, note: l.note, field: l.field_changed, old: l.old_value, val: l.new_value, time: l.created_at, attachmentPath: l.attachment_path, attachmentName: l.attachment_name })
    })
