...
const DOC_TYPES = {
  quotation: { title: 'QUOTATION', prefix: 'QT', color: '#6366F1' },
  invoice:   { title: 'INVOICE', prefix: 'INV', color: '#10B981' },
  proforma:  { title: 'PROFORMA INVOICE', prefix: 'PI', color: '#3A86FF' },
  receipt:   { title: 'RECEIPT', prefix: 'RC', color: '#E85D04' },
}
